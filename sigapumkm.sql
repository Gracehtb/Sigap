...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Bulan Mei 2020 pada 14.05
...
INSERT INTO `berita` (`id_berita`, `judul`, `isi`, `tgl_terbit`, `penulis`, `link`) VALUES
('BR01', 'Pengusaha UMKM Dapat Bebas Bea Masuk dan Pajak, In', '\"Pemerintah melalui Direktorat Jenderal Bea dan Cukai (DJBC) telah meluncurkan fasilitas terbaru bernama Kemudahan Impor Tujuan Ekspor untuk Industri kecil dan menengah (KITE IKM) dengan tujuan meningkatkan ekspor. Fasilitas yang membebaskan bea masuk dan pajak-pajak terutang ini diharapkan dapat menarik minat para pelaku usaha IKM.\r\n\r\nSelepas peluncuran fasilitas KITE IKM di Desa Tumang, Boyolali, Jawa Tengah, Direktur Jenderal Bea Cukai, Heru Pambudi menjelaskan prosedur untuk mendapatkan fasilitas tersebut.\r\n\r\n\"\"Untuk mendapatkan fasilitas, badan usaha yang tergolong dalam IKM harus mengajukan permohonan dengan memenuhi beberapa kriteria,\"\" ungkap Heru dalam keterangan resminya di Jakarta, Senin (30/1/2017).\r\n\r\nDia menambahkan, kriteria yang diperlukan bagi IKM untuk memperoleh fasilitas ini, antara lain pertama, memiliki kegiatan IKM yang dibuktikan dengan izin usaha industri.\r\n\r\nKedua, IKM juga harus bersedia untuk mengoperasikan modul kepabeanan yang diciptakan khusus untuk fasil', '2017-01-30', 'Fiki Ariyanti', 'Liputan6.com'),
('BR02', 'Aplikasi Ini Bantu UMKM Rambah Bisnis Online', '\"ndonesia memiliki banyak pengusaha di sektor mikro, kecil dan menengah (UMKM). Tercatat, ada sekitar 57,3 juta pengusaha di sektor UMKM di Indonesia. Namun ternyata hanya 9 persen dari UMKM tersebut yang memiliki kemampuan e-commerce.\r\n\r\nHal inilah yang membuat Glen Chandra dan Ahmad Fikri Ardian membuat aplikasi bernama Osman. Aplikasi ini membantuk para pengusaha untuk mengembangkan bisnis online alias e-commerce.\r\n\r\nCo-Founder aplikasi Osman Glen Chandra mengatakan, ide mengembangkan aplikasi ini berawal dari banyaknya masalah pelaku UMKM yang terkendala dengan pengembangan usaha di media online. Sehingga Osman menjadi pihak yang membantu UMKM di industri e-commerce.\r\n\r\n\"\"Dengan sama-sama kita bisa lakukan. Seperti gotong royong semua UMKM bisa terhubung dan masalah itu bisa diselesaikan dengan aplikasi Osman,\"\" katanya seperti dikutip Minggu (31/12/2017).\r\n\r\nIcal panggilan Chandra mengatakan ada tiga fitur utama di aplikasi Osman. Pertama fitur manajemen penjualan dimana penjual b', '2017-12-31', 'Yanuar H', 'Liputan6.com'),
('BR03', 'BRI Gandeng Indonesia In Your Hand Dorong Ekspor P', 'Pandemi Coronavirus Disease 2019 atau COVID-19 yang tengah melanda seluruh dunia tidak menyurutkan peran Bank BRI dalam meningkatkan ekspor dan menaikkan kelas UMKM Indonesia agar Go Global. Terbaru, perseroan bekerja sama dengan Indonesia In Your Hand mengekspor puluhan jenis produk Usaha Mikro, Kecil dan Menengah (UMKM) ke Australia, Selandia Baru dan negara Pasifik Selatan lainnya.\r\n\r\nDirektur Bisnis Mikro Bank BRI Supari menjelaskan, produk UMKM yang di ekspor merupakan kreasi dari para anggota binaan dari Rumah Kreatif BUMN (RKB) BRI.\r\n\r\n“Hingga saat ini BRI telah memiliki 55 RKB dengan anggota mencapai hampir 400 ribu pelaku UMKM dan telah mengadakan 3.994 pelatihan untuk mendorong UMKM Go Global. Melalui pelatihan bersama BRIncubator, diharapkan produk – produk yang dihasilkan dapat menyesuaikan dengan standar Internasional,” imbuh Supari.\r\n\r\nIndonesia In Your Hand sendiri sebuah marketplace yang khusus menjual produk Indonesia di luar negeri dan memiliki kantor di Amsterdam & S', '2020-04-28', 'Gilar Ramdhani', 'Liputan6.com'),
('BR04', 'Percobaan', 'Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan Percobaan ', '2020-05-05', 'Admin 1', 'liputan6.com'),
('BR05', 'Malam minggu yang produktif', 'KAmi mahasiswa online berusaha produktif di malam minggu ini :)', '2020-05-12', 'Admin Boongan', 'LIputanMahasiswaONline.com');
...
INSERT INTO `galeri` (`id_galeri`, `nama_gal`, `foto`, `id_usaha`) VALUES
('G01', 'Gerabah', 'keramik.jpg', 'US01'),
('G02', 'Totebag', 'sablon.jpg', 'US02'),
('G03', 'Makanan ringan', 'kripikbelut.jpg', 'US03');
...
('A04', 'aku salah buat kode wkwkwkkw'),
('KAT01', 'Usaha Kerajinan Tangan'),
('KAT02', 'Usaha Fashion'),
('KAT03', 'Usaha Kuliner');
...
INSERT INTO `usaha` (`id_usaha`, `nama_ush`, `alamat_ush`, `ket_ush`, `longitude`, `latitude`, `id_kel`, `id_kec`, `id_kat`) VALUES
('US01', 'Putra Insan Keramik & Craft', 'Kasongan, Kajen, Jl. Kasongan, RT. 01, Bangunjiwo, Kajen, Bangunjiwo, Daerah Istimewa Yogyakarta, Bantul, Daerah Istimewa Yogyakarta 55184', 'Usaha gerabah dengan produk souvenir, pot guci\r\n', '1103336036', '-78458961', 'KEL035', 'KEC07', 'KAT01'),
('US02', 'Moodglory Store', 'Cobongan, Ngestiharjo, Kasihan, Bantul Regency, Special Region of Yogyakarta 55184', 'Usaha Fashion sablonan dengan produk baju, titebas, souvenis, dll', '1103451622', '-77942558', 'KEL036', 'KEC07', 'KAT02'),
('US03', 'Kripik Belut Mitra Ibu Tini', 'Jl. Godean No.7, Jetis, Sidoagung, Jetis, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55293', 'Usaha Kuliner dengan produk makanan berupa kripik olahan dari belut', '1102980445', '-77583983', 'KEL324', 'KEC52', 'KAT03');
...
(1, 'admin1', '123', 'admin1@gmail.com', 'Admin 1', '081234567890', 'admin', '2020-05-02 07:53:29', 'user_no_image.jpg', '2020-05-02 07:53:29', 1);
...
ALTER TABLE `kecamatan`
  ...
  ADD UNIQUE KEY `id_kec_2` (`id_kec`);
