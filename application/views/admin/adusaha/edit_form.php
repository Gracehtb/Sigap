						...
						<!-- Note: atribut action dikosongkan, artinya action-nya akan diproses 
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('nama_ush') ? 'is-invalid':'' ?>"
								 type="text" name="judul" placeholder="Nama usaha" value="<?php echo $adusaha->nama_ush ?>" />
							...
							<div class="form-group">
								...
								<textarea class="form-control <?php echo form_error('alamat_ush') ? 'is-invalid':'' ?>"
								 name="isi" placeholder="Alamat Usaha"><?php echo $adusaha->alamat_ush ?></textarea>
								<div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('ket_ush') ? 'is-invalid':'' ?>"
								 type="date" name="ket_ush" placeholder="Keterangan usaha" value="<?php echo $adusaha->ket_ush ?>" />
								<div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('id_kel') ? 'is-invalid':'' ?>"
								 type="text" name="id_kel" placeholder="ID Kelurahan" value="<?php echo $adusaha->id_kel ?>" />
								<div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('id_kec') ? 'is-invalid':'' ?>"
								 type="text" name="id_kec" placeholder="ID Kecamatan" value="<?php echo $adusaha->id_kec ?>" />
								<div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('id_kat') ? 'is-invalid':'' ?>"
								 type="text" name="id_kat" placeholder="ID Kategori" value="<?php echo $adusaha->id_kat ?>" />
								<div class="invalid-feedback">
