...
class Mkecamatan extends CI_Controller
{
    ...
    {
        $data["mkecamatan"] = $this->kecamatan_model->getAll();
        $this->load->view("member/kecamatan/list", $data);
    }
    ...
    public function add()
    {
        ...
        $this->load->view("member/kecamatan/new_form");
    }

    public function edit($id_kec = null)
    {
        if (!isset($id_kec)) redirect('member/kecamatan');
        ...
        $this->load->view("member/kecamatan/edit_form", $data);
    }
    ...
    public function delete($id_kec=null)
    {
        ...
        if ($this->kecamatan_model->delete($id_kec)) {
            redirect(site_url('member/kecamatan'));
        }
    }
}