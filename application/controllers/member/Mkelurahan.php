...
class Mkelurahan extends CI_Controller
{
    ...
    {
        $data["mkelurahan"] = $this->kelurahan_model->getAll();
        $this->load->view("member/kelurahan/list", $data);
    }
    ...
    public function add()
    {
        ...
        $this->load->view("member/kelurahan/new_form");
    }

    public function edit($id_kel = null)
    {
        if (!isset($id_kel)) redirect('member/kelurahan');
        ...
        $this->load->view("member/kelurahan/edit_form", $data);
    }
    ...
    public function delete($id_kel=null)
    {
        ...
        if ($this->kelurahan_model->delete($id_kel)) {
            redirect(site_url('member/kelurahan'));
        }
    }
}